...
void loop() {
    ...
    float setPoint = phControl.getSetPoint();
    serialCom.printTask("READ", phControl.getCurrent(), setPoint);
    phControl.calculateError();

    displays.display(phControl.getCurrent());
    displays.display(setPoint, "asd");
