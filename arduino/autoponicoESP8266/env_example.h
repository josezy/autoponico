...
#define _INFLUXDB_URL "https://autoponico.tucanorobotics.co/influxdb" // FIXME: point to local influxdb, set up container?
#define _INFLUXDB_ORG ""
#define _INFLUXDB_BUCKET ""
#define _INFLUXDB_TOKEN ""
